...
Precisamos de um **Application Load Balancer (ALB)** na AWS para servir como proxy HTTPS para o backend do Radiante v2 (EC2). Atualmente o frontend (Amplify, HTTPS) não consegue se comunicar com o backend (EC2, HTTP) devido a erro de **Mixed Content** bloqueado pelo navegador.
...
> ⚠️ **Obs**: Criar os registros CNAME no DNS para validar o certificado.
